...
export function AlertsPanel() {
  ...
  const scheduleCollection = (alert: Alert) => {
    alert("🚛 Collection Scheduled Successfully for " + (alert.binName ?? ""));
  ...
  const addDummyAlert = () => {
    const newAlert: Alert = {
      ...
      title: "New Bin Alert Generated",
      message: "A new alert was generated automatically from IoT sensor data.",
      binId: "BIN-NEW",
      binName: "Random Location",
    ...
    <div className="space-y-6">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg p-6 relative">
            ...
            <div className="flex items-start gap-3 mb-4">
              <div className={`${getIconColor(selectedAlert.type)} mt-1`}>
            ...
            <div className="flex gap-3 mt-5">
              {!selectedAlert.resolved && (
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition font-semibold"
                >
                  Resolve
                </button>
              )}
              ...
              <button
                onClick={() => setSelectedAlert(null)}
                className="flex-1 px-4 py-2 bg-gray-100 text-gray-800 rounded-xl hover:bg-gray-200 transition font-semibold"
              >
                Close
              </button>
            </div>
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors font-semibold border border-gray-300"
            >
              Mark All as Read
            </button>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      {alert.type === "critical" && (
                        <button
                          onClick={() => scheduleCollection(alert)}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        {resolvedAlerts.length === 0 ? (
          <p className="text-gray-500 text-sm">No resolved alerts yet.</p>
        ) : (
          <div className="space-y-3">
            {resolvedAlerts.map((alert) => (
              <div
                key={alert.id}
                className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200 opacity-70"
              >
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={() =>
                  setSettings((prev) => ({ ...prev, sms: !prev.sms }))
                }
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
            </label>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={() =>
                  setSettings((prev) => ({ ...prev, push: !prev.push }))
                }
              />
              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
            </label>
